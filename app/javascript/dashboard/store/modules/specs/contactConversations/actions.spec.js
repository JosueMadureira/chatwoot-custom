...
describe('#actions', () => {
  ...
  describe('#create', () => {
    ...
    it('throws ExceptionWithMessage with API error body on 422', async () => {
      const apiMessage =
        'Este contato já possui um atendimento em aberto com o agente Maria';
      axios.post.mockRejectedValue({
        response: { status: 422, data: { error: apiMessage } },
      });
      ...
      expect(caught).toBeInstanceOf(ExceptionWithMessage);
      expect(caught.data).toEqual(apiMessage);
    });

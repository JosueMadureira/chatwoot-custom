...
// Duplo clique responde a mensagem (mesma identidade do Chat Interno). Ignora
// links/imagens (têm ações próprias) e só vale quando a mensagem permite reply
// (mesma regra do item "Responder" do menu de contexto).
